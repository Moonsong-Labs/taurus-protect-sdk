...
public class TgvalidatordInternalUser {
   ...
   * @return the TgvalidatordInternalUser instance itself
   */
  public TgvalidatordInternalUser putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, tgvalidatordInternalUser.id) &&
        ...
        Objects.equals(this.additionalProperties, tgvalidatordInternalUser.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, tenantId, externalUserId, firstName, lastName, status, email, roles, passwordChanged, publicKey, groups, enforcedInRules, creationDate, updateDate, totpEnabled, keyContainer, username, lastLogin, attributes, apiKeys, visibilityGroups, publicKeyEnforcedInRules, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordInternalUser>() {
           ...
           public TgvalidatordInternalUser read(JsonReader in) throws IOException {
             ...
             TgvalidatordInternalUser instance = thisAdapter.fromJsonTree(jsonObj);
