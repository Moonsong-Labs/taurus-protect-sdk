...
public class TgvalidatordERCTokenMetadata {
   ...
   * @return the TgvalidatordERCTokenMetadata instance itself
   */
  public TgvalidatordERCTokenMetadata putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, tgvalidatordERCTokenMetadata.name) &&
        ...
        Objects.equals(this.additionalProperties, tgvalidatordERCTokenMetadata.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, decimals, dataType, base64Data, uri, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordERCTokenMetadata>() {
           ...
           public TgvalidatordERCTokenMetadata read(JsonReader in) throws IOException {
             ...
             TgvalidatordERCTokenMetadata instance = thisAdapter.fromJsonTree(jsonObj);
