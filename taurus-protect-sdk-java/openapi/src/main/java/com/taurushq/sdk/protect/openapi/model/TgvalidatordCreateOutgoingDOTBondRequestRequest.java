...
public class TgvalidatordCreateOutgoingDOTBondRequestRequest {
   ...
   * @return the TgvalidatordCreateOutgoingDOTBondRequestRequest instance itself
   */
  public TgvalidatordCreateOutgoingDOTBondRequestRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fromAddressId, tgvalidatordCreateOutgoingDOTBondRequestRequest.fromAddressId) &&
        ...
        Objects.equals(this.additionalProperties, tgvalidatordCreateOutgoingDOTBondRequestRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fromAddressId, amount, restakeRewards, feeLimit, comment, useAllFunds, transactionReference, externalRequestId, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordCreateOutgoingDOTBondRequestRequest>() {
           ...
           public TgvalidatordCreateOutgoingDOTBondRequestRequest read(JsonReader in) throws IOException {
             ...
             TgvalidatordCreateOutgoingDOTBondRequestRequest instance = thisAdapter.fromJsonTree(jsonObj);
