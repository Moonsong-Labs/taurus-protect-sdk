...
public class TgvalidatordBusinessRule {
   ...
   * @return the TgvalidatordBusinessRule instance itself
   */
  public TgvalidatordBusinessRule putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, tgvalidatordBusinessRule.id) &&
        ...
        Objects.equals(this.additionalProperties, tgvalidatordBusinessRule.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, tenantId, currency, walletId, ruleKey, ruleValue, ruleGroup, ruleDescription, ruleValidation, addressId, currencyInfo, entityType, entityID, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordBusinessRule>() {
           ...
           public TgvalidatordBusinessRule read(JsonReader in) throws IOException {
             ...
             TgvalidatordBusinessRule instance = thisAdapter.fromJsonTree(jsonObj);
