...
public class TgvalidatordCreateOutgoingDeployContractRequestRequest {
   ...
   * @return the TgvalidatordCreateOutgoingDeployContractRequestRequest instance itself
   */
  public TgvalidatordCreateOutgoingDeployContractRequestRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fromAddressId, tgvalidatordCreateOutgoingDeployContractRequestRequest.fromAddressId) &&
        ...
        Objects.equals(this.additionalProperties, tgvalidatordCreateOutgoingDeployContractRequestRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fromAddressId, Arrays.hashCode(bytecode), constructor, generateWhitelistedAddress, gasLimit, gasPriceLimit, comment, contractType, feePayerId, feeLimit, contract, transactionReference, externalRequestId, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordCreateOutgoingDeployContractRequestRequest>() {
           ...
           public TgvalidatordCreateOutgoingDeployContractRequestRequest read(JsonReader in) throws IOException {
             ...
             TgvalidatordCreateOutgoingDeployContractRequestRequest instance = thisAdapter.fromJsonTree(jsonObj);
