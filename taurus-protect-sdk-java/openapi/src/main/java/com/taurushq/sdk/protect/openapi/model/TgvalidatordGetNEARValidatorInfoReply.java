...
public class TgvalidatordGetNEARValidatorInfoReply {
   ...
   * @return the TgvalidatordGetNEARValidatorInfoReply instance itself
   */
  public TgvalidatordGetNEARValidatorInfoReply putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.validatorAddress, tgvalidatordGetNEARValidatorInfoReply.validatorAddress) &&
        ...
        Objects.equals(this.additionalProperties, tgvalidatordGetNEARValidatorInfoReply.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(validatorAddress, ownerId, totalStakedBalance, rewardFeeFraction, stakingKey, isStakingPaused, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordGetNEARValidatorInfoReply>() {
           ...
           public TgvalidatordGetNEARValidatorInfoReply read(JsonReader in) throws IOException {
             ...
             TgvalidatordGetNEARValidatorInfoReply instance = thisAdapter.fromJsonTree(jsonObj);
