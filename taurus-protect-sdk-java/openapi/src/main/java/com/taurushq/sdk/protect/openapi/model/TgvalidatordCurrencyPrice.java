...
public class TgvalidatordCurrencyPrice {
   ...
   * @return the TgvalidatordCurrencyPrice instance itself
   */
  public TgvalidatordCurrencyPrice putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordCurrencyPrice>() {
           ...
           public TgvalidatordCurrencyPrice read(JsonReader in) throws IOException {
             ...
             TgvalidatordCurrencyPrice instance = thisAdapter.fromJsonTree(jsonObj);
