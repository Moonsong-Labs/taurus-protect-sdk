...
public class TgvalidatordChange {
  ...
  public TgvalidatordChange entityUUID(UUID entityUUID) {
   ...
   * @return the TgvalidatordChange instance itself
   */
  public TgvalidatordChange putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, tgvalidatordChange.id) &&
        ...
        Objects.equals(this.additionalProperties, tgvalidatordChange.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, tenantId, creatorId, action, entityId, entity, changes, creationDate, comment, entityUUID, creatorExternalId, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordChange>() {
           ...
           public TgvalidatordChange read(JsonReader in) throws IOException {
             ...
             TgvalidatordChange instance = thisAdapter.fromJsonTree(jsonObj);
