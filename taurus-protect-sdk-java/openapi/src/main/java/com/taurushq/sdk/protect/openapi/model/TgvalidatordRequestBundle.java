...
public class TgvalidatordRequestBundle {
   ...
   * @return the TgvalidatordRequestBundle instance itself
   */
  public TgvalidatordRequestBundle putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, tgvalidatordRequestBundle.id) &&
        ...
        Objects.equals(this.additionalProperties, tgvalidatordRequestBundle.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, tenantId, blockchain, details, status, creationDate, updateDate, requests, network, signedRequestBundles, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordRequestBundle>() {
           ...
           public TgvalidatordRequestBundle read(JsonReader in) throws IOException {
             ...
             TgvalidatordRequestBundle instance = thisAdapter.fromJsonTree(jsonObj);
