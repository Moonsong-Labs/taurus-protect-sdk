...
import com.taurushq.sdk.protect.openapi.model.TgvalidatordDefaultSharedAddresses;
import com.taurushq.sdk.protect.openapi.model.TgvalidatordTnLendingOffer;
import com.taurushq.sdk.protect.openapi.model.TgvalidatordTnParticipantAttribute;
...
public class TgvalidatordTnParticipant {
  ...
  public static final String SERIALIZED_NAME_PUBLIC_SUBNAME = "publicSubname";
  @SerializedName(SERIALIZED_NAME_PUBLIC_SUBNAME)
  private String publicSubname;
  ...
  private List<TgvalidatordTnParticipantAttribute> attributes = new ArrayList<>();

  public static final String SERIALIZED_NAME_STATUS = "status";
  @SerializedName(SERIALIZED_NAME_STATUS)
  private String status;

  public static final String SERIALIZED_NAME_TN_LENDING_OFFERS = "tnLendingOffers";
  @SerializedName(SERIALIZED_NAME_TN_LENDING_OFFERS)
  private List<TgvalidatordTnLendingOffer> tnLendingOffers = new ArrayList<>();

  public static final String SERIALIZED_NAME_DEFAULT_SHARED_ADDRESSES = "defaultSharedAddresses";
  @SerializedName(SERIALIZED_NAME_DEFAULT_SHARED_ADDRESSES)
  private TgvalidatordDefaultSharedAddresses defaultSharedAddresses;
  ...
  public TgvalidatordTnParticipant publicSubname(String publicSubname) {
    this.publicSubname = publicSubname;
    return this;
  }

  /**
   * Get publicSubname
   * @return publicSubname
   */
  @javax.annotation.Nullable
  public String getPublicSubname() {
    return publicSubname;
  }

  public void setPublicSubname(String publicSubname) {
    this.publicSubname = publicSubname;
  }


  public TgvalidatordTnParticipant legalEntityIdentifier(String legalEntityIdentifier) {
  ...
  public TgvalidatordTnParticipant attributes(List<TgvalidatordTnParticipantAttribute> attributes) {
    this.attributes = attributes;
    return this;
  }

  public TgvalidatordTnParticipant addAttributesItem(TgvalidatordTnParticipantAttribute attributesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<TgvalidatordTnParticipantAttribute> getAttributes() {
    return attributes;
  }

  public void setAttributes(List<TgvalidatordTnParticipantAttribute> attributes) {
    this.attributes = attributes;
  }


  public TgvalidatordTnParticipant status(String status) {
    this.status = status;
    return this;
  }
  ...
  public TgvalidatordTnParticipant tnLendingOffers(List<TgvalidatordTnLendingOffer> tnLendingOffers) {
    this.tnLendingOffers = tnLendingOffers;
    return this;
  }

  public TgvalidatordTnParticipant addTnLendingOffersItem(TgvalidatordTnLendingOffer tnLendingOffersItem) {
    if (this.tnLendingOffers == null) {
      this.tnLendingOffers = new ArrayList<>();
    }
    this.tnLendingOffers.add(tnLendingOffersItem);
    return this;
  }

  /**
   * Get tnLendingOffers
   * @return tnLendingOffers
   */
  @javax.annotation.Nullable
  public List<TgvalidatordTnLendingOffer> getTnLendingOffers() {
    return tnLendingOffers;
  }

  public void setTnLendingOffers(List<TgvalidatordTnLendingOffer> tnLendingOffers) {
    this.tnLendingOffers = tnLendingOffers;
  }


  public TgvalidatordTnParticipant defaultSharedAddresses(TgvalidatordDefaultSharedAddresses defaultSharedAddresses) {
    this.defaultSharedAddresses = defaultSharedAddresses;
    return this;
  }

  /**
   * Get defaultSharedAddresses
   * @return defaultSharedAddresses
   */
  @javax.annotation.Nullable
  public TgvalidatordDefaultSharedAddresses getDefaultSharedAddresses() {
    return defaultSharedAddresses;
  }

  public void setDefaultSharedAddresses(TgvalidatordDefaultSharedAddresses defaultSharedAddresses) {
    this.defaultSharedAddresses = defaultSharedAddresses;
  }
   ...
   * @return the TgvalidatordTnParticipant instance itself
   */
  public TgvalidatordTnParticipant putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, tgvalidatordTnParticipant.id) &&
        ...
        Objects.equals(this.publicSubname, tgvalidatordTnParticipant.publicSubname) &&
        Objects.equals(this.legalEntityIdentifier, tgvalidatordTnParticipant.legalEntityIdentifier) &&
        Objects.equals(this.attributes, tgvalidatordTnParticipant.attributes) &&
        Objects.equals(this.status, tgvalidatordTnParticipant.status) &&
        Objects.equals(this.tnLendingOffers, tgvalidatordTnParticipant.tnLendingOffers) &&
        Objects.equals(this.defaultSharedAddresses, tgvalidatordTnParticipant.defaultSharedAddresses)&&
        Objects.equals(this.additionalProperties, tgvalidatordTnParticipant.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, legalAddress, country, logoBase64, publicKey, shield, originRegistrationDate, originDeletionDate, createdAt, updatedAt, details, blockConfirmations, ownedSharedAddressesCount, targetedSharedAddressesCount, outgoingTotalPledgesValuationBaseCurrency, incomingTotalPledgesValuationBaseCurrency, publicSubname, legalEntityIdentifier, attributes, status, tnLendingOffers, defaultSharedAddresses, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    publicSubname: ").append(toIndentedString(publicSubname)).append("\n");
    sb.append("    legalEntityIdentifier: ").append(toIndentedString(legalEntityIdentifier)).append("\n");
    sb.append("    attributes: ").append(toIndentedString(attributes)).append("\n");
    sb.append("    status: ").append(toIndentedString(status)).append("\n");
    sb.append("    tnLendingOffers: ").append(toIndentedString(tnLendingOffers)).append("\n");
    sb.append("    defaultSharedAddresses: ").append(toIndentedString(defaultSharedAddresses)).append("\n");
  ...
  static {
    ...
    openapiFields.add("publicSubname");
    openapiFields.add("legalEntityIdentifier");
    openapiFields.add("attributes");
    openapiFields.add("status");
    openapiFields.add("tnLendingOffers");
    openapiFields.add("defaultSharedAddresses");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("publicSubname") != null && !jsonObj.get("publicSubname").isJsonNull()) && !jsonObj.get("publicSubname").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `publicSubname` to be a primitive type in the JSON string but got `%s`", jsonObj.get("publicSubname").toString()));
      }
      ...
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        ...
        if (jsonArrayattributes != null) {
          ...
          for (int i = 0; i < jsonArrayattributes.size(); i++) {
            TgvalidatordTnParticipantAttribute.validateJsonElement(jsonArrayattributes.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("tnLendingOffers") != null && !jsonObj.get("tnLendingOffers").isJsonNull()) {
        JsonArray jsonArraytnLendingOffers = jsonObj.getAsJsonArray("tnLendingOffers");
        if (jsonArraytnLendingOffers != null) {
          // ensure the json data is an array
          if (!jsonObj.get("tnLendingOffers").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `tnLendingOffers` to be an array in the JSON string but got `%s`", jsonObj.get("tnLendingOffers").toString()));
          }

          // validate the optional field `tnLendingOffers` (array)
          for (int i = 0; i < jsonArraytnLendingOffers.size(); i++) {
            TgvalidatordTnLendingOffer.validateJsonElement(jsonArraytnLendingOffers.get(i));
          };
        }
      }
      // validate the optional field `defaultSharedAddresses`
      if (jsonObj.get("defaultSharedAddresses") != null && !jsonObj.get("defaultSharedAddresses").isJsonNull()) {
        TgvalidatordDefaultSharedAddresses.validateJsonElement(jsonObj.get("defaultSharedAddresses"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordTnParticipant>() {
           ...
           public TgvalidatordTnParticipant read(JsonReader in) throws IOException {
             ...
             TgvalidatordTnParticipant instance = thisAdapter.fromJsonTree(jsonObj);
