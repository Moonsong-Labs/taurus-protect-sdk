...
public class ETHRemote {
  ...
  public ETHRemote forwarderKind(TgvalidatordFeePayerForwarderKind forwarderKind) {
  ...
  public ETHRemote domainSeparator(byte[] domainSeparator) {
   ...
   * @return the ETHRemote instance itself
   */
  public ETHRemote putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.url, eTHRemote.url) &&
        ...
        Objects.equals(this.forwarderKind, eTHRemote.forwarderKind) &&
        Arrays.equals(this.domainSeparator, eTHRemote.domainSeparator)&&
        Objects.equals(this.additionalProperties, eTHRemote.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(url, username, password, privateKey, fromAddressId, forwarderAddress, forwarderAddressId, creatorAddress, creatorAddressId, forwarderKind, Arrays.hashCode(domainSeparator), additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ETHRemote>() {
           ...
           public ETHRemote read(JsonReader in) throws IOException {
             ...
             ETHRemote instance = thisAdapter.fromJsonTree(jsonObj);
