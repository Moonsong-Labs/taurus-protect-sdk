...
public class TgvalidatordGetICPNeuronInfoReply {
   ...
   * @return the TgvalidatordGetICPNeuronInfoReply instance itself
   */
  public TgvalidatordGetICPNeuronInfoReply putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.neuronId, tgvalidatordGetICPNeuronInfoReply.neuronId) &&
        ...
        Objects.equals(this.additionalProperties, tgvalidatordGetICPNeuronInfoReply.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(neuronId, retrieveAtTimestampSeconds, neuronState, ageSeconds, dissolveDelaySeconds, votingPower, createdTimestampSeconds, stakeE8S, joinedCommunityFundTimestampSeconds, knownNeuronData, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordGetICPNeuronInfoReply>() {
           ...
           public TgvalidatordGetICPNeuronInfoReply read(JsonReader in) throws IOException {
             ...
             TgvalidatordGetICPNeuronInfoReply instance = thisAdapter.fromJsonTree(jsonObj);
