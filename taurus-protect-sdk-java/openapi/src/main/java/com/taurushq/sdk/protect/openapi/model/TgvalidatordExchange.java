...
public class TgvalidatordExchange {
   ...
   * @return the TgvalidatordExchange instance itself
   */
  public TgvalidatordExchange putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, tgvalidatordExchange.id) &&
        ...
        Objects.equals(this.additionalProperties, tgvalidatordExchange.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, exchange, account, currency, type, totalBalance, status, container, label, creationDate, updateDate, currencyInfo, hasWLA, displayLabel, baseCurrencyValuation, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordExchange>() {
           ...
           public TgvalidatordExchange read(JsonReader in) throws IOException {
             ...
             TgvalidatordExchange instance = thisAdapter.fromJsonTree(jsonObj);
