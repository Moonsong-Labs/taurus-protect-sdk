...
public class TargetAddress {
   ...
   * @return the TargetAddress instance itself
   */
  public TargetAddress putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.kind, targetAddress.kind) &&
        ...
        Objects.equals(this.additionalProperties, targetAddress.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(kind, addressID, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TargetAddress>() {
           ...
           public TargetAddress read(JsonReader in) throws IOException {
             ...
             TargetAddress instance = thisAdapter.fromJsonTree(jsonObj);
