...
public class TgvalidatordUTXO {
  ...
  public TgvalidatordUTXO valueString(String valueString) {
   ...
   * @return the TgvalidatordUTXO instance itself
   */
  public TgvalidatordUTXO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, tgvalidatordUTXO.id) &&
        ...
        Objects.equals(this.valueString, tgvalidatordUTXO.valueString)&&
        Objects.equals(this.additionalProperties, tgvalidatordUTXO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, hash, outputIndex, script, value, blockHeight, reservedByRequestId, reservationId, valueString, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordUTXO>() {
           ...
           public TgvalidatordUTXO read(JsonReader in) throws IOException {
             ...
             TgvalidatordUTXO instance = thisAdapter.fromJsonTree(jsonObj);
