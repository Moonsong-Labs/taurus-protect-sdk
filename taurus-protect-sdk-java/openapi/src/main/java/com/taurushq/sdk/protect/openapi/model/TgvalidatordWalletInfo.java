...
public class TgvalidatordWalletInfo {
  ...
  public TgvalidatordWalletInfo externalWalletId(String externalWalletId) {
   ...
   * @return the TgvalidatordWalletInfo instance itself
   */
  public TgvalidatordWalletInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, tgvalidatordWalletInfo.id) &&
        ...
        Objects.equals(this.externalWalletId, tgvalidatordWalletInfo.externalWalletId)&&
        Objects.equals(this.additionalProperties, tgvalidatordWalletInfo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, balance, currency, coin, name, container, seed, accountPath, isOmnibus, creationDate, updateDate, customerId, comment, disabled, blockchain, addressesCount, currencyInfo, attributes, network, visibilityGroupID, externalWalletId, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordWalletInfo>() {
           ...
           public TgvalidatordWalletInfo read(JsonReader in) throws IOException {
             ...
             TgvalidatordWalletInfo instance = thisAdapter.fromJsonTree(jsonObj);
