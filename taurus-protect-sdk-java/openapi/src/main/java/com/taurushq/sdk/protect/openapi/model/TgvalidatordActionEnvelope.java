...
public class TgvalidatordActionEnvelope {
   ...
   * @return the TgvalidatordActionEnvelope instance itself
   */
  public TgvalidatordActionEnvelope putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, tgvalidatordActionEnvelope.id) &&
        ...
        Objects.equals(this.additionalProperties, tgvalidatordActionEnvelope.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, tenantId, label, action, status, creationDate, updateDate, lastcheckeddate, autoApprove, attributes, trails, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordActionEnvelope>() {
           ...
           public TgvalidatordActionEnvelope read(JsonReader in) throws IOException {
             ...
             TgvalidatordActionEnvelope instance = thisAdapter.fromJsonTree(jsonObj);
