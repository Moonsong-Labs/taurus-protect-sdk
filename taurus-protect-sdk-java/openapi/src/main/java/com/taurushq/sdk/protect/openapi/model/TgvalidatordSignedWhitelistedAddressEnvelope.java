...
public class TgvalidatordSignedWhitelistedAddressEnvelope {
  ...
  public TgvalidatordSignedWhitelistedAddressEnvelope rulesSignatures(String rulesSignatures) {
   ...
   * @return the TgvalidatordSignedWhitelistedAddressEnvelope instance itself
   */
  public TgvalidatordSignedWhitelistedAddressEnvelope putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, tgvalidatordSignedWhitelistedAddressEnvelope.id) &&
        ...
        Objects.equals(this.rulesSignatures, tgvalidatordSignedWhitelistedAddressEnvelope.rulesSignatures)&&
        Objects.equals(this.additionalProperties, tgvalidatordSignedWhitelistedAddressEnvelope.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, tenantId, signedAddress, metadata, action, scores, trails, rulesContainer, rule, approvers, attributes, rulesContainerHash, blockchain, status, network, visibilityGroupID, tnParticipantID, rulesSignatures, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordSignedWhitelistedAddressEnvelope>() {
           ...
           public TgvalidatordSignedWhitelistedAddressEnvelope read(JsonReader in) throws IOException {
             ...
             TgvalidatordSignedWhitelistedAddressEnvelope instance = thisAdapter.fromJsonTree(jsonObj);
