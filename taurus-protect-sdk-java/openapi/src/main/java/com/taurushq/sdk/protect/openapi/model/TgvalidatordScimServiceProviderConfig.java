...
public class TgvalidatordScimServiceProviderConfig {
   ...
   * @return the TgvalidatordScimServiceProviderConfig instance itself
   */
  public TgvalidatordScimServiceProviderConfig putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.schemas, tgvalidatordScimServiceProviderConfig.schemas) &&
        ...
        Objects.equals(this.additionalProperties, tgvalidatordScimServiceProviderConfig.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemas, documentationUri, patch, bulk, filter, changePassword, sort, etag, authenticationSchemes, meta, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordScimServiceProviderConfig>() {
           ...
           public TgvalidatordScimServiceProviderConfig read(JsonReader in) throws IOException {
             ...
             TgvalidatordScimServiceProviderConfig instance = thisAdapter.fromJsonTree(jsonObj);
