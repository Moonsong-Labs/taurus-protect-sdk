...
public class TgvalidatordTagAssetStatistics {
   ...
   * @return the TgvalidatordTagAssetStatistics instance itself
   */
  public TgvalidatordTagAssetStatistics putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tagID, tgvalidatordTagAssetStatistics.tagID) &&
        ...
        Objects.equals(this.additionalProperties, tgvalidatordTagAssetStatistics.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tagID, currencyID, totalBalance, totalBalanceValuation, creationDate, currencyInfo, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordTagAssetStatistics>() {
           ...
           public TgvalidatordTagAssetStatistics read(JsonReader in) throws IOException {
             ...
             TgvalidatordTagAssetStatistics instance = thisAdapter.fromJsonTree(jsonObj);
