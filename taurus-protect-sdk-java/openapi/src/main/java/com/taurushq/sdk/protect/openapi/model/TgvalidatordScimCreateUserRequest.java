...
public class TgvalidatordScimCreateUserRequest {
   ...
   * @return the TgvalidatordScimCreateUserRequest instance itself
   */
  public TgvalidatordScimCreateUserRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.schemas, tgvalidatordScimCreateUserRequest.schemas) &&
        ...
        Objects.equals(this.additionalProperties, tgvalidatordScimCreateUserRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemas, externalId, name, emails, roles, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordScimCreateUserRequest>() {
           ...
           public TgvalidatordScimCreateUserRequest read(JsonReader in) throws IOException {
             ...
             TgvalidatordScimCreateUserRequest instance = thisAdapter.fromJsonTree(jsonObj);
