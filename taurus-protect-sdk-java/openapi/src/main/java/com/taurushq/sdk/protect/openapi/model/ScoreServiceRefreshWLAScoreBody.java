...
public class ScoreServiceRefreshWLAScoreBody {
   ...
   * @return the ScoreServiceRefreshWLAScoreBody instance itself
   */
  public ScoreServiceRefreshWLAScoreBody putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.scoreProvider, scoreServiceRefreshWLAScoreBody.scoreProvider)&&
        Objects.equals(this.additionalProperties, scoreServiceRefreshWLAScoreBody.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ScoreServiceRefreshWLAScoreBody>() {
           ...
           public ScoreServiceRefreshWLAScoreBody read(JsonReader in) throws IOException {
             ...
             ScoreServiceRefreshWLAScoreBody instance = thisAdapter.fromJsonTree(jsonObj);
