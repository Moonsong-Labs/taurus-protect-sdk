...
public class TgvalidatordCreateOutgoingXLMPathPaymentStrictReceiveRequestRequest {
   ...
   * @return the TgvalidatordCreateOutgoingXLMPathPaymentStrictReceiveRequestRequest instance itself
   */
  public TgvalidatordCreateOutgoingXLMPathPaymentStrictReceiveRequestRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, tgvalidatordCreateOutgoingXLMPathPaymentStrictReceiveRequestRequest.amount) &&
        ...
        Objects.equals(this.additionalProperties, tgvalidatordCreateOutgoingXLMPathPaymentStrictReceiveRequestRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amount, maxSenderAmount, feeLimit, fromAddressId, toAddressId, toWhitelistedAddressId, destinationAssetID, destinationAssetIssuer, comment, externalRequestId, destinationAddressMemo, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordCreateOutgoingXLMPathPaymentStrictReceiveRequestRequest>() {
           ...
           public TgvalidatordCreateOutgoingXLMPathPaymentStrictReceiveRequestRequest read(JsonReader in) throws IOException {
             ...
             TgvalidatordCreateOutgoingXLMPathPaymentStrictReceiveRequestRequest instance = thisAdapter.fromJsonTree(jsonObj);
