...
public class TgvalidatordRequest {
  ...
  public TgvalidatordRequest travelRuleDataInput(TgvalidatordTravelRuleDataInput travelRuleDataInput) {
   ...
   * @return the TgvalidatordRequest instance itself
   */
  public TgvalidatordRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, tgvalidatordRequest.id) &&
        ...
        Objects.equals(this.travelRuleDataInput, tgvalidatordRequest.travelRuleDataInput)&&
        Objects.equals(this.additionalProperties, tgvalidatordRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, tenantId, currency, envelope, status, trails, signedRequests, creationDate, updateDate, metadata, attributes, rule, approvers, type, currencyInfo, needsApprovalFrom, requestBundleId, externalRequestId, travelRuleDataInput, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordRequest>() {
           ...
           public TgvalidatordRequest read(JsonReader in) throws IOException {
             ...
             TgvalidatordRequest instance = thisAdapter.fromJsonTree(jsonObj);
