...
public class TgvalidatordAddressInfo {
   ...
   * @return the TgvalidatordAddressInfo instance itself
   */
  public TgvalidatordAddressInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.address, tgvalidatordAddressInfo.address) &&
        ...
        Objects.equals(this.additionalProperties, tgvalidatordAddressInfo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(address, label, container, customerId, amount, amountMainUnit, type, idx, internalAddressId, whitelistedAddressId, scores, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordAddressInfo>() {
           ...
           public TgvalidatordAddressInfo read(JsonReader in) throws IOException {
             ...
             TgvalidatordAddressInfo instance = thisAdapter.fromJsonTree(jsonObj);
