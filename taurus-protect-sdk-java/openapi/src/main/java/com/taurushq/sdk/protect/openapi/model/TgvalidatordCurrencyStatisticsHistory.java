...
public class TgvalidatordCurrencyStatisticsHistory {
   ...
   * @return the TgvalidatordCurrencyStatisticsHistory instance itself
   */
  public TgvalidatordCurrencyStatisticsHistory putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.symbol, tgvalidatordCurrencyStatisticsHistory.symbol) &&
        ...
        Objects.equals(this.additionalProperties, tgvalidatordCurrencyStatisticsHistory.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(symbol, blockchain, history, currencyInfo, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordCurrencyStatisticsHistory>() {
           ...
           public TgvalidatordCurrencyStatisticsHistory read(JsonReader in) throws IOException {
             ...
             TgvalidatordCurrencyStatisticsHistory instance = thisAdapter.fromJsonTree(jsonObj);
