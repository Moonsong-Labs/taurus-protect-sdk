...
public class TgvalidatordCreateWhitelistedAddressRequest {
   ...
   * @return the TgvalidatordCreateWhitelistedAddressRequest instance itself
   */
  public TgvalidatordCreateWhitelistedAddressRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.address, tgvalidatordCreateWhitelistedAddressRequest.address) &&
        ...
        Objects.equals(this.currency, tgvalidatordCreateWhitelistedAddressRequest.currency)&&
        Objects.equals(this.additionalProperties, tgvalidatordCreateWhitelistedAddressRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(address, memo, label, exchangeAccountId, customerId, linkedInternalAddressIds, addressType, contractType, linkedWalletIds, blockchain, network, visibilityGroupID, currency, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordCreateWhitelistedAddressRequest>() {
           ...
           public TgvalidatordCreateWhitelistedAddressRequest read(JsonReader in) throws IOException {
             ...
             TgvalidatordCreateWhitelistedAddressRequest instance = thisAdapter.fromJsonTree(jsonObj);
