...
public class TgvalidatordCreateOutgoingCosmosGenericRequestRequest {
   ...
   * @return the TgvalidatordCreateOutgoingCosmosGenericRequestRequest instance itself
   */
  public TgvalidatordCreateOutgoingCosmosGenericRequestRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.chainId, tgvalidatordCreateOutgoingCosmosGenericRequestRequest.chainId) &&
        ...
        Objects.equals(this.additionalProperties, tgvalidatordCreateOutgoingCosmosGenericRequestRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(chainId, signers, feeDenom, fee, feePayer, gasLimit, messages, comment, useUnconfirmedFunds, transactionReference, broadcastKind, accountsInfo, memo, externalRequestId, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordCreateOutgoingCosmosGenericRequestRequest>() {
           ...
           public TgvalidatordCreateOutgoingCosmosGenericRequestRequest read(JsonReader in) throws IOException {
             ...
             TgvalidatordCreateOutgoingCosmosGenericRequestRequest instance = thisAdapter.fromJsonTree(jsonObj);
