...
public class AuthProxyApiRequestToValidate {
   ...
   * @return the AuthProxyApiRequestToValidate instance itself
   */
  public AuthProxyApiRequestToValidate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.prefix, authProxyApiRequestToValidate.prefix) &&
        ...
        Objects.equals(this.additionalProperties, authProxyApiRequestToValidate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(prefix, apiKey, nonce, timestamp, method, host, path, query, contentType, Arrays.hashCode(body), Arrays.hashCode(signature), additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AuthProxyApiRequestToValidate>() {
           ...
           public AuthProxyApiRequestToValidate read(JsonReader in) throws IOException {
             ...
             AuthProxyApiRequestToValidate instance = thisAdapter.fromJsonTree(jsonObj);
