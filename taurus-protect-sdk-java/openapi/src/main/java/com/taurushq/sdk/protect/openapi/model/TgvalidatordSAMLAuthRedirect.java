...
public class TgvalidatordSAMLAuthRedirect {
   ...
   * @return the TgvalidatordSAMLAuthRedirect instance itself
   */
  public TgvalidatordSAMLAuthRedirect putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.token, tgvalidatordSAMLAuthRedirect.token) &&
        ...
        Objects.equals(this.additionalProperties, tgvalidatordSAMLAuthRedirect.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(token, location, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordSAMLAuthRedirect>() {
           ...
           public TgvalidatordSAMLAuthRedirect read(JsonReader in) throws IOException {
             ...
             TgvalidatordSAMLAuthRedirect instance = thisAdapter.fromJsonTree(jsonObj);
