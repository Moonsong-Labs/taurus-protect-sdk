...
public class TgvalidatordReservation {
   ...
   * @return the TgvalidatordReservation instance itself
   */
  public TgvalidatordReservation putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, tgvalidatordReservation.id) &&
        ...
        Objects.equals(this.additionalProperties, tgvalidatordReservation.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, amount, creationDate, kind, comment, addressid, address, currencyInfo, asset, resourceId, resourceType, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordReservation>() {
           ...
           public TgvalidatordReservation read(JsonReader in) throws IOException {
             ...
             TgvalidatordReservation instance = thisAdapter.fromJsonTree(jsonObj);
