...
public class TgvalidatordCreateOutgoingXLMClawbackRequestRequest {
  ...
  public TgvalidatordCreateOutgoingXLMClawbackRequestRequest() {
  }

  public TgvalidatordCreateOutgoingXLMClawbackRequestRequest fromAddressId(String fromAddressId) {
  ...
  public TgvalidatordCreateOutgoingXLMClawbackRequestRequest toAddressId(String toAddressId) {
  ...
  public TgvalidatordCreateOutgoingXLMClawbackRequestRequest toWhitelistedAddressId(String toWhitelistedAddressId) {
  ...
  public TgvalidatordCreateOutgoingXLMClawbackRequestRequest destinationAddressMemo(String destinationAddressMemo) {
  ...
  public TgvalidatordCreateOutgoingXLMClawbackRequestRequest amount(String amount) {
    this.amount = amount;
    return this;
  }
  ...
  public TgvalidatordCreateOutgoingXLMClawbackRequestRequest feeLimit(String feeLimit) {
  ...
  public TgvalidatordCreateOutgoingXLMClawbackRequestRequest comment(String comment) {
  ...
  public TgvalidatordCreateOutgoingXLMClawbackRequestRequest externalRequestId(String externalRequestId) {
   ...
   * @return the TgvalidatordCreateOutgoingXLMClawbackRequestRequest instance itself
   */
  public TgvalidatordCreateOutgoingXLMClawbackRequestRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TgvalidatordCreateOutgoingXLMClawbackRequestRequest tgvalidatordCreateOutgoingXLMClawbackRequestRequest = (TgvalidatordCreateOutgoingXLMClawbackRequestRequest) o;
    return Objects.equals(this.fromAddressId, tgvalidatordCreateOutgoingXLMClawbackRequestRequest.fromAddressId) &&
        Objects.equals(this.toAddressId, tgvalidatordCreateOutgoingXLMClawbackRequestRequest.toAddressId) &&
        Objects.equals(this.toWhitelistedAddressId, tgvalidatordCreateOutgoingXLMClawbackRequestRequest.toWhitelistedAddressId) &&
        Objects.equals(this.destinationAddressMemo, tgvalidatordCreateOutgoingXLMClawbackRequestRequest.destinationAddressMemo) &&
        Objects.equals(this.amount, tgvalidatordCreateOutgoingXLMClawbackRequestRequest.amount) &&
        Objects.equals(this.feeLimit, tgvalidatordCreateOutgoingXLMClawbackRequestRequest.feeLimit) &&
        Objects.equals(this.comment, tgvalidatordCreateOutgoingXLMClawbackRequestRequest.comment) &&
        Objects.equals(this.externalRequestId, tgvalidatordCreateOutgoingXLMClawbackRequestRequest.externalRequestId)&&
        Objects.equals(this.additionalProperties, tgvalidatordCreateOutgoingXLMClawbackRequestRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fromAddressId, toAddressId, toWhitelistedAddressId, destinationAddressMemo, amount, feeLimit, comment, externalRequestId, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TgvalidatordCreateOutgoingXLMClawbackRequestRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TgvalidatordCreateOutgoingXLMClawbackRequestRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TgvalidatordCreateOutgoingXLMClawbackRequestRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TgvalidatordCreateOutgoingXLMClawbackRequestRequest is not found in the empty JSON string", TgvalidatordCreateOutgoingXLMClawbackRequestRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TgvalidatordCreateOutgoingXLMClawbackRequestRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TgvalidatordCreateOutgoingXLMClawbackRequestRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TgvalidatordCreateOutgoingXLMClawbackRequestRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TgvalidatordCreateOutgoingXLMClawbackRequestRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TgvalidatordCreateOutgoingXLMClawbackRequestRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordCreateOutgoingXLMClawbackRequestRequest>() {
           @Override
           public void write(JsonWriter out, TgvalidatordCreateOutgoingXLMClawbackRequestRequest value) throws IOException {
           ...
           @Override
           public TgvalidatordCreateOutgoingXLMClawbackRequestRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TgvalidatordCreateOutgoingXLMClawbackRequestRequest instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of TgvalidatordCreateOutgoingXLMClawbackRequestRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TgvalidatordCreateOutgoingXLMClawbackRequestRequest
   * @throws IOException if the JSON string is invalid with respect to TgvalidatordCreateOutgoingXLMClawbackRequestRequest
   */
  public static TgvalidatordCreateOutgoingXLMClawbackRequestRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TgvalidatordCreateOutgoingXLMClawbackRequestRequest.class);
  }

  /**
   * Convert an instance of TgvalidatordCreateOutgoingXLMClawbackRequestRequest to an JSON string
   *
   * @return JSON string
   */
