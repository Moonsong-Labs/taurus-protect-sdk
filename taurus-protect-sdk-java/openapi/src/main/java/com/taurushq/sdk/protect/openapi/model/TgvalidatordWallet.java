...
public class TgvalidatordWallet {
  ...
  public TgvalidatordWallet() {
  }

  public TgvalidatordWallet id(String id) {
    this.id = id;
    return this;
  }
  ...
  public TgvalidatordWallet balance(TgvalidatordBalance balance) {
  ...
  public TgvalidatordWallet currency(String currency) {
  ...
  public TgvalidatordWallet coin(String coin) {
    this.coin = coin;
    return this;
  }
  ...
  public TgvalidatordWallet name(String name) {
    this.name = name;
    return this;
  }
  ...
  public TgvalidatordWallet container(String container) {
  ...
  public TgvalidatordWallet seed(String seed) {
    this.seed = seed;
    return this;
  }
  ...
  public TgvalidatordWallet accountPath(String accountPath) {
  ...
  public TgvalidatordWallet addresses(List<TgvalidatordAddress> addresses) {
    this.addresses = addresses;
    return this;
  }

  public TgvalidatordWallet addAddressesItem(TgvalidatordAddress addressesItem) {
  ...
  public TgvalidatordWallet isOmnibus(Boolean isOmnibus) {
  ...
  public TgvalidatordWallet creationDate(OffsetDateTime creationDate) {
  ...
  public TgvalidatordWallet updateDate(OffsetDateTime updateDate) {
  ...
  public TgvalidatordWallet customerId(String customerId) {
  ...
  public TgvalidatordWallet comment(String comment) {
  ...
  public TgvalidatordWallet disabled(Boolean disabled) {
  ...
  public TgvalidatordWallet blockchain(String blockchain) {
  ...
  public TgvalidatordWallet addressesCount(String addressesCount) {
  ...
  public TgvalidatordWallet attributes(List<TgvalidatordWalletAttribute> attributes) {
    this.attributes = attributes;
    return this;
  }

  public TgvalidatordWallet addAttributesItem(TgvalidatordWalletAttribute attributesItem) {
  ...
  public TgvalidatordWallet currencyInfo(TgvalidatordCurrency currencyInfo) {
  ...
  public TgvalidatordWallet externalWalletId(String externalWalletId) {
   ...
   * @return the TgvalidatordWallet instance itself
   */
  public TgvalidatordWallet putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TgvalidatordWallet tgvalidatordWallet = (TgvalidatordWallet) o;
    return Objects.equals(this.id, tgvalidatordWallet.id) &&
        Objects.equals(this.balance, tgvalidatordWallet.balance) &&
        Objects.equals(this.currency, tgvalidatordWallet.currency) &&
        Objects.equals(this.coin, tgvalidatordWallet.coin) &&
        Objects.equals(this.name, tgvalidatordWallet.name) &&
        Objects.equals(this.container, tgvalidatordWallet.container) &&
        Objects.equals(this.seed, tgvalidatordWallet.seed) &&
        Objects.equals(this.accountPath, tgvalidatordWallet.accountPath) &&
        Objects.equals(this.addresses, tgvalidatordWallet.addresses) &&
        Objects.equals(this.isOmnibus, tgvalidatordWallet.isOmnibus) &&
        Objects.equals(this.creationDate, tgvalidatordWallet.creationDate) &&
        Objects.equals(this.updateDate, tgvalidatordWallet.updateDate) &&
        Objects.equals(this.customerId, tgvalidatordWallet.customerId) &&
        Objects.equals(this.comment, tgvalidatordWallet.comment) &&
        Objects.equals(this.disabled, tgvalidatordWallet.disabled) &&
        Objects.equals(this.blockchain, tgvalidatordWallet.blockchain) &&
        Objects.equals(this.addressesCount, tgvalidatordWallet.addressesCount) &&
        Objects.equals(this.attributes, tgvalidatordWallet.attributes) &&
        Objects.equals(this.currencyInfo, tgvalidatordWallet.currencyInfo) &&
        Objects.equals(this.externalWalletId, tgvalidatordWallet.externalWalletId)&&
        Objects.equals(this.additionalProperties, tgvalidatordWallet.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, balance, currency, coin, name, container, seed, accountPath, addresses, isOmnibus, creationDate, updateDate, customerId, comment, disabled, blockchain, addressesCount, attributes, currencyInfo, externalWalletId, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TgvalidatordWallet {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TgvalidatordWallet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TgvalidatordWallet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TgvalidatordWallet is not found in the empty JSON string", TgvalidatordWallet.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TgvalidatordWallet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TgvalidatordWallet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TgvalidatordWallet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TgvalidatordWallet.class));

       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordWallet>() {
           @Override
           public void write(JsonWriter out, TgvalidatordWallet value) throws IOException {
           ...
           @Override
           public TgvalidatordWallet read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TgvalidatordWallet instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of TgvalidatordWallet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TgvalidatordWallet
   * @throws IOException if the JSON string is invalid with respect to TgvalidatordWallet
   */
  public static TgvalidatordWallet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TgvalidatordWallet.class);
  }

  /**
   * Convert an instance of TgvalidatordWallet to an JSON string
   *
   * @return JSON string
   */
