...
public class TgvalidatordSecurityDomain {
   ...
   * @return the TgvalidatordSecurityDomain instance itself
   */
  public TgvalidatordSecurityDomain putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, tgvalidatordSecurityDomain.id) &&
        ...
        Objects.equals(this.additionalProperties, tgvalidatordSecurityDomain.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, tenantId, domain, mode, attributes, creationDate, updateDate, enabled, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordSecurityDomain>() {
           ...
           public TgvalidatordSecurityDomain read(JsonReader in) throws IOException {
             ...
             TgvalidatordSecurityDomain instance = thisAdapter.fromJsonTree(jsonObj);
