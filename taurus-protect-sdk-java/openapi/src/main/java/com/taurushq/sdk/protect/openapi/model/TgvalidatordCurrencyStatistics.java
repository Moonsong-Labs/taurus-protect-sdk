...
public class TgvalidatordCurrencyStatistics {
   ...
   * @return the TgvalidatordCurrencyStatistics instance itself
   */
  public TgvalidatordCurrencyStatistics putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.symbol, tgvalidatordCurrencyStatistics.symbol) &&
        ...
        Objects.equals(this.additionalProperties, tgvalidatordCurrencyStatistics.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(symbol, blockchain, avgBalancePerAddress, addressesCount, walletsCount, totalBalance, baseCurrencyTotalValue, baseCurrencyTotalValueMainUnit, currencyInfo, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TgvalidatordCurrencyStatistics>() {
           ...
           public TgvalidatordCurrencyStatistics read(JsonReader in) throws IOException {
             ...
             TgvalidatordCurrencyStatistics instance = thisAdapter.fromJsonTree(jsonObj);
